...
module reactTSX{
   ...
   */
  export interface Props extends __React.HTMLAttributes, __React.ClassAttributes<any> {
  }
  ...
  export type El = (props:Props, ...children: any[])=>__React.ReactElement<any>
   ...
   *                     BASIC ELEMENTS                     *
   **********************************************************/
  export var a:(props:aProps, ...children:any[]) => React.ReactElement<aProps> =
    (props, ...children) => {
